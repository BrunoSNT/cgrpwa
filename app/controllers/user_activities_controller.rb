class UserActivitiesController < ApplicationController
  ...
  def create
    @user_activity = UserActivity.new(user_activity_params.merge(user_id: current_user.id))
    

    respond_to do |format|
      if @user_activity.save
        format.html { redirect_to activities_path, notice: 'Inscrito na atividade com sucesso.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to activities_path, notice: 'Se desinscreveu com sucesso.' }
